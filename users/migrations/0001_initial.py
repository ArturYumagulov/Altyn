    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.CharField(blank=True, default=None, max_length=1000, null=True, verbose_name='Сайт')),
                ('social_networks', models.CharField(blank=True, default=None, max_length=2000, null=True, verbose_name='Социальные сети')),
                ('male', models.CharField(blank=True, choices=[('M', 'Мужской'), ('F', 'Женский')], default=None, max_length=1, null=True, verbose_name='Пол')),
                ('birthday', models.DateField(blank=True, default=None, null=True, verbose_name='Дата рождения')),
                ('company_name', models.CharField(blank=True, default=None, max_length=1000, null=True, verbose_name='Наименование компании')),
                ('platform_name', models.CharField(blank=True, default=None, max_length=1000, null=True, verbose_name='Наименование компании')),
                ...
                ('location', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='regions.location', verbose_name='Локация')),
                ('region', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='regions.region', verbose_name='Регион')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
                ('roles', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.roles', verbose_name='Роль')),
            ],
            options={
